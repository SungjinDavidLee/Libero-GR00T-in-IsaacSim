...
| 문서 | 내용 |
|---|---|
| [methodology.md](methodology.md) | 실행 절차와 조건, 표본 크기에 관한 주의 |
| [adapter.md](adapter.md) | 관측·상태·스케일·주기 규약, 참조에 없는 요소 |
| [calibration.md](calibration.md) | 개루프 정합 절차, 폐루프 조정이 실패하는 이유 |
| [success_criteria.md](success_criteria.md) | 단계 정의, 문턱의 근거, 민감도 곡선 |
