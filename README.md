...
graph LR
    ...
    P["GR00T N1.6<br/>libero_spatial 체크포인트<br/>가중치 고정"]
    P --> M
    P --> I
    M -.동일 가중치.-> I
```
...
| IK | Lula, 폴백 4단계 |
| 정책 | GR00T N1.6, `libero_spatial` 체크포인트, embodiment tag `libero_sim` |
